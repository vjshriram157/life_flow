    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (!tokens.isEmpty()) {
                ...
                // 📧 Send immediate "Registration Received" confirmation email
                String userName = users.get(0).getString("full_name");
                com.bloodbank.util.EmailService.sendRegistrationReceivedEmail(email, userName);
