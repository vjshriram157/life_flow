...
<head>
    <meta charset="UTF-8">
    <title>Verify OTP | LifeFlow</title>
    ...
    <div class="card text-white p-2 p-md-4" style="background-color: rgba(15, 23, 42, 0.95); border: 1px solid rgba(255,255,255,0.1); border-radius: 1.5rem; box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.5);">
        <div class="card-body">
            <div class="text-center mb-4">
                ...
                <p class="text-white-50 small">Enter the 6-digit OTP sent to <strong><%= request.getParameter("email") != null ? request.getParameter("email") : "your email" %></strong>.</p>
            </div>
            ...
            <form action="<%=request.getContextPath()%>/ResetPasswordServlet" method="post">
                ...
                <button type="submit" class="btn btn-premium w-100 py-3 mb-2 rounded-3 fw-bold">Verify & Update Password</button>
            </form>
            
            <div class="text-center mt-3">
                <a href="<%=request.getContextPath()%>/forgotPassword.jsp" class="text-white-50 text-decoration-none hover-white small"><i class="fa-solid fa-rotate-right me-1"></i> Resend OTP</a>
            </div>
        </div>
    </div>
</div>
