                ...
                <div class="card card-modern p-4 p-md-5 border-0 h-100">
                    <div class="card-body">
                        ...
                        <form action="<%= request.getContextPath() %>/BookAppointmentServlet" method="post">
                            <input type="hidden" name="requestId" value="<%= request.getAttribute("requestId") != null ? request.getAttribute("requestId") : "" %>">
                            <input type="hidden" name="alertId" value="<%= request.getAttribute("alertId") != null ? request.getAttribute("alertId") : "" %>">
                            <div class="mb-4">
